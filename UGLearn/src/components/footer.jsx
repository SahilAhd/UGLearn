    ...
    <footer className="footer">
      <div className="footer-container arima">
        ...
        <div className="footer-section">
          ...
          <a href="tel:+919898057571" className="footer-info">
            <FaPhone />
            <span className="underline-animation">+918368505428 </span>
          </a>
          <a href="mailto:help.lecturax@gmail.com" className="footer-info">
            <FaEnvelope />{" "}
            <span className="underline-animation">help.UGLearn@gmail.com</span>
          </a>
          {/* Social Links */}
      ...
      <div className="footer-bottom">
        <p className="footer-copyright montserrat">
          © 2024 UGLearn Pvt Ltd. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
